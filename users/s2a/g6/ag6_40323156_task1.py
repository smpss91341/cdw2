...
ag6_40323156 = Blueprint('ag6_40323156', __name__, url_prefix='/ag6_40323156', template_folder='templates')

# 展示傳回 Brython 程式
@ag6_40323156.route('/A')
def task1():
    outstring = '''
