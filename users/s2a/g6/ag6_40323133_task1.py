...
ag6_40323133 = Blueprint('ag6_40323133', __name__, url_prefix='/ag6_40323133', template_folder='templates')

# 展示傳回 Brython 程式
@ag6_40323133.route('/A')
def task1():
    outstring = '''
