...
ag4_40323138abcd = Blueprint('ag4_40323138abcd', __name__, url_prefix='/ag4_40323138abcd', template_folder='templates')

# 展示傳回 Brython 程式
@ag4_40323138abcd.route('/abcd')
def task1():
    outstring = '''
    <!DOCTYPE html>
<html>
