...
ag4_40323135bacd = Blueprint('ag4_40323135bacd', __name__, url_prefix='/ag4_40323135bacd', template_folder='templates')

# 展示傳回 Brython 程式
@ag4_40323135bacd.route('/bacd')
def task1():
    outstring = '''
    <!DOCTYPE html>
<html>
