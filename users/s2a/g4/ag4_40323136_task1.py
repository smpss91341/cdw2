...
ag4_40323136 = Blueprint('ag4_40323136', __name__, url_prefix='/ag4_40323136', template_folder='templates')

# 展示傳回 Brython 程式
@ag4_40323136.route('/A')
def task1():
    outstring = '''
...
O(0, 0, 0, 0, 0, "lightpink", True, 4)
'''
    return outstring
    
@ag4_40323136.route('/C')
def task3():
    outstring = '''
from javascript import JSConstructor
from browser import window
