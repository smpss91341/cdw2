...
scrum6_task40123128 = Blueprint('scrum6_task40123128', __name__, url_prefix='/bg4', template_folder='templates')

# scrum1_task1 為完整可以單獨執行的繪圖程式
@scrum6_task40123128.route('/scrum6_EF')
def scrum6_EF():
    outstring = '''
<!DOCTYPE html>
<html>
...
#畫E
#下面兩個平行單元
x1, y1 = mychain.basic_rot(0, -100, 0, color="green")
x2, y2 = mychain.basic_rot(x1, y1, 0, color="green")
# 左邊四個垂直個單元
x3, y3 = mychain.basic_rot(0, -100, 90, color="green")
x4, y4 = mychain.basic_rot(x3, y3, 90, color="green")
x5, y5 = mychain.basic_rot(x4, y4, 90, color="green")
x6, y6 = mychain.basic_rot(x5, y5, 90, color="green")
#中間一個平行單元
x7, y7 = mychain.basic_rot(x4, y4, 0, color="green")
# 上方兩個平行單元
x8, y8 = mychain.basic_rot(x6, y6, 0, color="green")
x9, y9 = mychain.basic_rot(x8, y8, 0, color="green")
 

#畫F
#左邊四個垂直個單元
x1, y1 = mychain.basic_rot(65, -100, 90, color="green")
...
x6, y6 = mychain.basic_rot(x5, y5, 0, color="green")
#中間一個平行單元
x7, y7 = mychain.basic_rot(x2, y2, 0, color="green")
