...
def O(x, y, rx, ry, rot, color, border, linewidth):
    ...
    basic1A = cmbr.dup()
    basic1A.rotate(180)
    basic1A.translate(-80, -20)
    basic2A = cmbr.dup()
    basic2A.rotate(0)
    basic2A.translate(-40, -20)
    basic1B = cmbr.dup()
    basic1B.rotate(90)
    basic1B.translate(0, 40)
    basic2B = cmbr.dup()
    basic2B.rotate(120)
    basic2B.translate(20, -40)
    basic1C = cmbr.dup()
    basic1C.rotate(59.73)
    basic1C.translate(82.74, -29.81)

    basic1D = cmbr.dup()
    basic1D.rotate(53.74)
    basic1D.translate(180, 40)
...
@scrum40123129_task1.route('/scrum_29')
def scrum_29():
    outstring = '''
...
class chain():
    ...
    def basic(self, x1, y1, x2, y2, color="white", border=True, linewidth=4, scale=1):
        self.x1 = x1
        self.y1 = y1
        self.x2 = x2
        self.y2 = y2
    ...
    def basic_rot(self, x1, y1, rot, color="white", border=True, linewidth=4, scale=1):
        self.x1 = x1
        self.y1 = y1
        self.rot = rot
        self.color = color
...
x2, y2 = mychain.basic_rot(x1, y1, 90, color="orange")
# 左斜邊兩個單元
...
x9, y9 = mychain.basic_rot(x8, y8, -90, color="orange")
# 中間兩個水平單元
...
# 上方一個水平單元
x5, y5 = mychain.basic_rot(x4, y4, 0, color="orange")
# 右斜 -30 度
...
# 右下斜 240 度
x12, y12 = mychain.basic_rot(x11, y11, 210, color="orange")
# 水平接回起點
...
# 下斜 -30 度
x6, y6 = mychain.basic_rot(x5, y5, -30, color="orange")
# 下方水平單元
...
x5, y5 = mychain.basic_rot(x4, y4, 0)
# 右斜 -40 度
x6, y6 = mychain.basic_rot(x5, y5, -40, color="orange")
