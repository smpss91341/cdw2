...
scrum4_task40323247 = Blueprint('scrum4_task40323247', __name__, url_prefix='/bg11', template_folder='templates')

# scrum4_task1 為完整可以單獨執行的繪圖程式
@scrum4_task40323247.route('/scrum4_D')
def scrum4_D():
    outstring = '''
<!DOCTYPE html>
<html>
...
x7, y7 = mychain.basic_rot(x6, y6, -70, color="blue")
# 右中垂直向下單元
x8, y8 = mychain.basic_rot(x7, y7, -90, color="blue")
# -110 度
x9, y9 = mychain.basic_rot(x8, y8, -100, color="blue")
# -150
x10, y10 = mychain.basic_rot(x9, y9, -150, color="blue")
# 水平接回原點
...
<!-- <script type="text/python" src="/bg11/scrum2_task1"></script>
<!-- 以協同方式加上 ag100 的  scrum-3 組員所寫的 task1 程式碼 -->
<!-- <script type="text/python" src="/bg11/scrum3_task1"></script>
